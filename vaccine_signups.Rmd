...
# drive_40min <- mb_isochrone("Leola, PA 17540",
#                           profile = "driving",
#                           time = 40)
# 
...
links <- c("https://www.wegmans.com/covid-vaccine-registration/", "https://giantsched.rxtouch.com/rbssched/program/covid19/Patient/Advisory", "https://covidinfo.reportsonline.com/covidinfo/GiantFood.html?queueittoken=e_giantfoodcovid19~q_cffbce75-75e1-4643-be70-ee6cd5d90735~ts_1612269313~ce_true~rt_safetynet~h_6021c466cb22ba819262fcba678c3655927c7a23e03a5e7ce338ab0667274b05", "https://www.wegmans.com/covid-vaccine-registration/")

names <- c("Wegmans Signup Link", "Giant Pharmacy Signup (Local Giants)", "The Other Kind of Giant Pharmacy Signup (further drive, still worthwhile)", "Wegmans Pharmacy Direct Link")

manual_add_links <- data.frame(names, links)
...
unique_websites %>% 
  mutate(PublicLink = cell_spec(PublicLink, "html", link = PublicLink, new_tab = TRUE)) %>% 
...
### Additional website links found by manually searching
...
tm_shape(drive_40min) + tm_borders(lwd = 2, col = "#6699cc") +
