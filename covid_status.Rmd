...
* 3 most recent days removed from analysis, as Philadelphia city notes recent days are incomplete. 
* The [specific dataset](https://www.opendataphilly.org/dataset/covid-cases/resource/85fead1a-0ec3-4856-98a9-27ba4fa941ee) used to populate this page appears to report test results based on the day they were taken, and not on the day the results were officially reported. Each day the city adds new data, but many cases are backdated, meaning the most recent days are incomplete and will change.
