---
title: "COVID Hospitalizations & Testing Metrics"
...
# %>% 
#   filter(zip_code != 19108 & zip_code != 19109 & zip_code != 19110 & zip_code != 19113 & zip_code != 19155 & zip_code != 19160 & zip_code != 19161 & zip_code != 19170 & zip_code != 19176 & zip_code != 19178 & zip_code != 19181 & zip_code & zip_code != 19183 & zip_code != 19188 & zip_code != 19190 & zip_code != 19191& zip_code != 19155 & zip_code != 19192 & zip_code != 19193  & zip_code != 19194  & zip_code != 19197) %>% 


pct_positive_by_zip_complete <- pct_positive_by_zip %>% 
  mutate(date = as.Date(etl_timestamp)) %>% 
  group_by(zip_code) %>% 
  filter(zip_code == 19143 | zip_code == 19104 | zip_code == 19146 | zip_code ==  19139 ) %>% 
  ...
  mutate(POS_imputed = na.approx(POS),
         ...
         NEG_14_day_cum = rollapplyr(NEG_new, width = 14, FUN = sum, partial = TRUE),
         PCT_postive_14_day = POS_14_day_cum/NEG_14_day_cum)


ggplotly(ggplotly(ggplot(pct_positive_by_zip_complete, aes(x = date, y = PCT_postive_14_day)) + 
  geom_line(aes(color = as.character(zip_code))) +
  xlab("") +
  ylab("% Positive (14-days)") +
